...
export const authOptions : NextAuthOptions = {
    ...
    // pages serve para redirecionar a página, ela faz com que a tela de login que foi criado pela própria aplicação seja ignorada e redirecionada para a nova tela de login que foi desenvolvida.
}